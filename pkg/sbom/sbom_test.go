...
import (
	...
	svcmocks "github.com/khulnasoft-lab/cli-extension-sbom/internal/mocks"
	"github.com/khulnasoft-lab/cli-extension-sbom/pkg/sbom"
)
...
func TestSBOMWorkflow_NoOrgID(t *testing.T) {
	...
	assert.ErrorContains(t, err, "vulnmap failed to infer an organization ID. Please make sure to authenticate using `khulnasoft-lab auth`. "+

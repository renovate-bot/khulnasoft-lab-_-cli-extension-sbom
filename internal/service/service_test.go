...
import (
	...
	"github.com/khulnasoft-lab/cli-extension-sbom/internal/errors"
	"github.com/khulnasoft-lab/cli-extension-sbom/internal/mocks"
	. "github.com/khulnasoft-lab/cli-extension-sbom/internal/service"
)
	...
	tc := map[string]struct {
		...
		"Bad Request": {
			...
			expectedErr: "SBOM generation failed due to bad input arguments. " +
				"Please make sure you are using the latest version of the Vulnmap CLI.",
		},
		"Unauthorized": {
			statusCode: http.StatusUnauthorized,
			expectedErr: "Vulnmap failed to authenticate you based on on you API token. " +
				"Please ensure that you have authenticated by running `khulnasoft-lab auth`.",
		},
		"Forbidden": {
			...
			expectedErr: "Your account is not authorized to perform this action. " +
				...
				"entitled to use the Vulnmap API. (Org ID: c32727e4-2d6c-4780-aa1a-a89bcd16fe6f)",
		},
		"Other Errors": {
